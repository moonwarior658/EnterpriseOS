...
from app.models.supply import SupplySupplierConfirmation, SupplySupplierOrder
from app.supply.supplier_confirmations import create_confirmation, record_confirmation
...
class SupplySupplierConfirmationsPostgresTests(unittest.TestCase):
    ...
    def test_cycle_constraints_tenant_fk_concurrency_and_locking(self) -> None:
        ...
        command.downgrade(self.config, "20260915_0045")
