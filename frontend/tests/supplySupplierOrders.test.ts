...
test('подключает admin-only список, карточку и формирование из allocation workspace', () => {
  ...
  assert.match(confirmation, /formatQuantity\(line\.confirmed_quantity_base\)/)
  assert.match(confirmation, /input-with-suffix/)
  ...
  assert.match(acceptances, /Принято с расхождениями/)
